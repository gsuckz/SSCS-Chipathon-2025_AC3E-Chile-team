...
C {vco/stage_v3p1_GF180-5V.sym} -310 -10 0 0 {name=x1}
C {vco/stage_v3p1_GF180-5V.sym} -120 -10 0 0 {name=x2}
C {vco/stage_v3p1_GF180-5V.sym} 70 -10 0 0 {name=x3}
C {vco/stage_v3p1_GF180-5V.sym} 260 -10 0 0 {name=x4}
C {vco/stage_v3p1_GF180-5V.sym} 450 -10 0 0 {name=x5}
