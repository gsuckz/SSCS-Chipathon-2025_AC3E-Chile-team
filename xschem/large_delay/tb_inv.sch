...
C {/foss/designs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_1.sym} -152.5 132.5 0 0 {name=x4 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {/foss/designs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_2.sym} -17.5 132.5 0 0 {name=x5 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {/foss/designs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_3.sym} 117.5 132.5 0 0 {name=x6 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
...
C {/foss/designs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_4.sym} -150 212.5 0 0 {name=x1 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {/foss/designs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_8.sym} -15 212.5 0 0 {name=x2 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {/foss/designs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_12.sym} 120 212.5 0 0 {name=x3 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
...
C {/foss/designs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_20.sym} -15 285 0 0 {name=x8 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
...
C {/foss/designs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_16.sym} -150 285 0 0 {name=x7 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
